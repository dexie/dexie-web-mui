...
const cloudPlans = [
  ...
  },
  {
    id: "business",
    title: "Business",
    subtitle: "When you need full control over your data.",
    price: "$3,495",
    priceNote: "forever",
    buttonText: "Buy now",
    buttonLink: {
  ...
  },
  {
    id: "enterprise",
    title: "Enterprise",
    subtitle: "When you need deeper integration and support.",
    price: "$7,995",
    priceNote: "forever",
    buttonText: "Buy now",
    buttonLink: {
