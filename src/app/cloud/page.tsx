    ...
    >
      <Box sx={{ mb: 4 }}>
        <Typography variant="body1" color="text.secondary" paragraph>
          Dexie Cloud erbjuder en kraftfull och skalbar molnlösning för dina
          Dexie-applikationer. Här hittar du all dokumentation för att komma
          igång med synkronisering, autentisering och mer.
        </Typography>
