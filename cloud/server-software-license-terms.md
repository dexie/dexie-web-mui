...
The **Dexie Cloud On-Prem Business Software** includes binaries and documentation necessary to deploy Dexie Cloud on your own infrastructure.

The **Dexie Cloud On-Prem Enterprise Software** includes all in Business plus source code and access to our private git repository.
